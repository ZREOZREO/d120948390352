...
module.exports = {
    ...
    execute(message){
        ...
        .setAuthor(`ROLE REMOVED by ${owner}`, img)
        .setThumbnail(img)
        .setTitle(`${member.user.tag} IS REMOVED ${role.name} BY ${message.author.tag}!`)
        ...
        .setThumbnail(img)
        .setTitle(`${member.user.tag}에게 ${role.name} 역할을 회수할 권한이 없습니다`)
